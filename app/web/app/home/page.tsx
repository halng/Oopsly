    ...
    return (
      ...
      >
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              <div
                ...
                style={{
                  backgroundColor: subject.color || "var(--theme-accent)",
                }}
              >
        ...
        <div className="p-4 pt-3 bg-stone-50/70 dark:bg-stone-800/50 border-t border-stone-100 dark:border-stone-800 space-y-2">
          ...
          <button
            onClick={() =>
              router.push(`/home/${subject.shelfId}/subjects/${subject.id}`)
            }
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-stone-500 dark:text-stone-400 mt-1">
              Organize your knowledge hierarchy: Shelves → Subjects → Cards &
              Tests.
            </p>
          </div>
            ...
            <div className="flex items-center gap-3.5 text-left w-full sm:w-auto">
              ...
              <div>
                <h3 className="text-sm font-bold text-stone-900 dark:text-stone-100 flex items-center gap-1.5">
                  <span>
                    {allShelvesTotalDue} Total Cards Due for Daily FSRS Review
                  </span>
                ...
                <p className="text-xs text-stone-600 dark:text-stone-400 mt-0.5">
                  Select any shelf below to dive into its subject decks and
                  start active recall.
                </p>
              </div>
            </div>
        ...
        {globalSubjectSearchQuery.trim() ? (
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 dark:text-stone-400 max-w-sm mt-1">
                Create your first Shelf to categorize and organize your subjects
                and study cards.
              </p>
            </div>
            <button
