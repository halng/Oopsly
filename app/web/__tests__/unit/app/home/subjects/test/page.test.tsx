...
import TestPage from '@/app/(app)/home/[shelfId]/subjects/[subjectId]/test/page';
...
describe('TestPage', () => {
    ...
    it('loads a generated test', async () => {
        render(<TestPage />);
        expect(screen.getByTestId('test-loading')).toBeInTheDocument();
        await waitFor(() =>
            expect(screen.getByTestId('test-suite-page')).toBeInTheDocument()
        );
        fireEvent.click(screen.getByTestId('btn-test-close'));
