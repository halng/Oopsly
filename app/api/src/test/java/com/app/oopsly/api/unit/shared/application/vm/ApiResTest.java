...
package com.app.oopsly.api.unit.shared.application.vm;

import static org.junit.jupiter.api.Assertions.*;

import com.app.oopsly.api.shared.application.vm.ApiRes;
import com.app.oopsly.api.shared.application.vm.Res;
...
class ApiResTest {
    ...
    void constructor_withBodyAndStatus_createsInstance() {
        Res body = new Res(true, java.time.Instant.now(), "Test", 200, null);
