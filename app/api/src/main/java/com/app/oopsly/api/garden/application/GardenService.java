...
public interface GardenService {
    ...
    ApiRes plantSeed(PlantSeedReq request);

    ApiRes waterTree(WaterTreeReq request);

    ApiRes unlockPlot(UnlockPlotReq request);

    ApiRes completePomodoroSession(CompletePomodoroReq request);
}
