...
public class ApiRes extends ResponseEntity<Res> {
  ...
  public static ApiRes internalError(String message) {
    return new ApiRes(
        new Res(500, message, null, false, Instant.now()), HttpStatus.INTERNAL_SERVER_ERROR);
  }
  ...
  public static ApiRes unauthorized(String message) {
    return new ApiRes(new Res(401, message, null, false, Instant.now()), HttpStatus.UNAUTHORIZED);
  }
}
