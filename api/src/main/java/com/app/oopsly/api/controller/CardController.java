...
@Validated
@Tag(name = "Card", description = "Card management APIs for creating, updating, retrieving and deleting cards within decks")
public class CardController {
    ...
    @Operation(
            ...
            description = "Creates new cards for a specific deck"
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Cards created successfully",
    ...
    @Operation(
            summary = "Update card",
            description = "Updates an existing card in a specific deck"
    )
    @ApiResponses(value = {
    ...
    ApiRes updateCard(
            @Parameter(description = "Deck ID", required = true, example = "123e4567-e89b-12d3-a456-426614174000")
            @PathVariable UUID deckId,
            @Parameter(description = "Card ID", required = true, example = "123e4567-e89b-12d3-a456-426614174001")
            @PathVariable UUID id,
            @Parameter(description = "Card update request", required = true)
            @Valid @RequestBody CardItemReq requestBody) {
    ...
    ApiRes updateDifficulty(
            ...
            @Valid @RequestBody List<UpdateDifficultyReq> requestBody) {
    ...
    @Operation(
            summary = "Delete card",
            description = "Soft deletes a card from a specific deck"
    )
    @ApiResponses(value = {
