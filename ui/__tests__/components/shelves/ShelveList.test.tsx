...
describe("ShelveList", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    (shelveService.fetchShelves as jest.Mock).mockResolvedValue(
  ...
  describe("Loading State", () => {
    it("shows loading indicator while fetching shelves", async () => {
      ...
      const pendingPromise = new Promise<ApiResponse<ShelvePaginatedResponse>>(
        (resolve) => {
  ...
  describe("Empty State", () => {
    it("shows empty state when no shelves exist", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(
            "Create your first shelve to start organizing your flashcards",
          ),
        ).toBeTruthy();
  ...
  describe("Error State", () => {
    it("shows error state when fetch fails", async () => {
      (shelveService.fetchShelves as jest.Mock).mockRejectedValue(
    ...
    it("creates shelve and refreshes list on successful creation", async () => {
      ...
      await act(async () => {
        fireEvent.changeText(
          screen.getByTestId("shelve-name-input"),
          "New Shelve",
        );
        fireEvent.changeText(
          screen.getByTestId("shelve-description-input"),
          "New description",
        );
      });
  ...
  describe("Delete Shelve", () => {
    ...
    it("reverts optimistic update on delete failure", async () => {
      (shelveService.deleteShelve as jest.Mock).mockRejectedValue(
